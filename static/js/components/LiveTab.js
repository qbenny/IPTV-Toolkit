            ...
            <div class="card live-list-card">
                ...
                <tbody id="live-channel-list-tbody" :key="tbodyKey">
                    ...
                    <tr v-for="ch in liveChannels" :key="ch.id" :data-id="ch.id" class="live-channel-row">
                        ...
                        <td class="nowrap"><span class="text-muted fw-600" v-if="ch.user_channel_id">{{ ch.user_channel_id }}</span><span class="text-muted fs-11" style="margin-left:8px" v-if="ch.channel_id">(ID: {{ ch.channel_id }})</span></td>
